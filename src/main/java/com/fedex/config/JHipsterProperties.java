...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "nadella@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "nadella API";

        private String description = "nadella API documentation";
